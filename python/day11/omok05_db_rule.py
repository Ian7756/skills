...
Ui_MainWindow, QtBaseClass = uic.loadUiType("omok05.ui")
...
class MyWindow(QMainWindow):
    ...
    def goCompTurn(self):
        int_i = random.randint(0,self.gameSize-1)
        int_j = random.randint(0,self.gameSize-1)
        while self.arr2d[int_i][int_j] > 0 :
            int_i = random.randint(0,self.gameSize-1)
            int_j = random.randint(0,self.gameSize-1)
